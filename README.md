# Omkar Mobile Center — Website (Sindagi)

- **Live:** https://shreekantha3.github.io/sindagi-omkar-mobile-center/
- **Repo:** `shreekantha3/sindagi-omkar-mobile-center` (branch `main` = source, `gh-pages` = deployed bundle where applicable)
- **Stack:** static Vite + Tailwind CSS, no backend. `base: '/sindagi-omkar-mobile-center/'` for GitHub Pages project-site hosting.
